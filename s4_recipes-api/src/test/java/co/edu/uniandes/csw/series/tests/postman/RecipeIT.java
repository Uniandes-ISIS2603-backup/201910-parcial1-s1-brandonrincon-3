...
import co.edu.uniandes.csw.recipes.resources.RestConfig;
import java.io.File;
...
public class RecipeIT {
    ...
    private static final String COLLECTION = "recetaCollection.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s4_recipes-api.war")//War del modulo api
